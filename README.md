...
| `explore-topic` | Maps a broad topic's ideas, vocabulary, perspectives, open questions, representative resources, and learning trails. | `gh skill install wcygan/agent-skills explore-topic --agent codex --scope user` |
...
| `improve-development-loop` | Improves repeated development work and promotes stable workflows into project-specific agent skills. | `gh skill install wcygan/agent-skills improve-development-loop --agent codex --scope user` |
