...
Apply the patterns relevant to the component being built or reviewed; they are not a checklist of changes every component needs.
...
Use this where motion improves press feedback without distracting from frequent actions. A subtle range is 0.95-0.98; respect reduced-motion preferences.

### Avoid scale(0) for ordinary component entrances
...
These principles come from building Sonner and illustrate component design tradeoffs:
...
For longer design work, reviewing with fresh eyes can help. This is optional and does not delay completion of the current request. You notice imperfections the next day that you missed during development. Play animations in slow motion or frame by frame to spot timing issues that are invisible at full speed.
