---
name: pr-guidelines
description: Evaluate one pull request for concise description structure, testing evidence, naming consistency, reviewability, code-quality signals, CI state, and whether its scope should be split. Use when preparing, checking, or improving an individual PR, including AI-generated changes.
license: MIT
---
